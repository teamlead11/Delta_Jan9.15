...
@CucumberOptions(features = "src/test/resources/feature/", glue = {"com.stepdefinition" }, plugin = {"com.resources.ExtentCucumberFormatter:" ,"json:src/main/resources/AutomationSuite/jsonReport.json","html:target"}, dryRun = false, monochrome = true)
